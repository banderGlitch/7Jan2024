    ...
    <div className="fixed right-0 top-[64px] bottom-[48px] flex">
      ...
      <div className="w-64 bg-black border-l border-gray-800 flex flex-col h-full">
        ...
        <div className="flex flex-1 min-h-0">
          ...
          {/* Filter Strip - Made responsive */}
          <div className="w-6 bg-gray-800 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700">
            <div className="flex flex-col items-center py-1 min-h-min">
              <button
                onClick={handleReset}
                className="w-4 h-4 md:w-3 md:h-3 mb-1 rounded-sm flex items-center justify-center bg-gray-800 text-gray-300 hover:bg-gray-700"
                title="Reset filter"
              >
              ...
              {filters.map((letter) => (
                <button
                  ...
                  className={`w-4 h-4 md:w-3 md:h-3 mb-1 rounded-sm flex items-center justify-center text-[8px] md:text-[6px] font-light
        ...
        {/* Footer */}
        <div className="w-full bg-black px-4 py-2 border-t border-gray-800">
